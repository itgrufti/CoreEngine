========================================================================
    KONSOLENANWENDUNG: CoreEngine_SFML-Projektübersicht
========================================================================

Diese CoreEngine_SFML-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CoreEngine_SFML-Anwendung besteht.


CoreEngine_SFML.vcxproj
...
CoreEngine_SFML.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen CoreEngine_SFML.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
